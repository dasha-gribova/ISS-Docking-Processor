...
### 1️⃣ **Запуск графического интерфейса**
```bash
python main.py --ui
# или просто
python main.py
...
**Дарья**  
Проект выполнен в рамках учебной задачи
